...
public interface IAppointmentService
{
	...
	public Task<IEnumerable<AppointmentResponseDto>> GetByJwtAsync(string jwt, CancellationToken cancellationToken);
	public Task<IEnumerable<AppointmentResponseDto>> GetAllAsync(CancellationToken cancellationToken);
	public Task<AppointmentResponseDto> CreateAsync(AppointmentRequestDto appointmentRequestDto, string jwt, CancellationToken cancellationToken);
